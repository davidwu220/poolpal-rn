...
export default class LocationSearchHeader extends Component {
  ...
  onSourceTextChange = (sourceText) => {
    ...
    this.props.onSourceTextChange(sourceText);
  }

  onDestinationTextChange = (destinationText) => {
    this.props.onDestinationTextChange(destinationText);
  }
  ...
  getAnimatableStyles = () => {
    ...
    return {
      hoverbar: {
        top: expanded ? 0 - 41 - 29 : 76 - 41,
        left: expanded ? 0 : 24,
        height: expanded ? 136 + 29 : 56,
        width: expanded ? windowWidth : width,
        shadowRadius: expanded ? 10 / 2 : 60 / 2,
      },
      square: {
        top: expanded ? 109 - 41 : 76 - 41 + 56 / 2 - SQUARE_SIZE / 2,
      ...
      sourceBox: {
        ...
        right: 24,
        height: 32,
        top: expanded ? 56 - 41 : 96 - 41,
        opacity: expanded ? 1 : 0,
      },
      sourceText: {
        left: 65,
        top: expanded ? 64 - 41 : 76 - 41,
        opacity: expanded ? 1 : 0,
      },
      verticalBar: {
        top: expanded ? 78 - 41 : 78 - 41 + 22 - 5,
        left: expanded ? 32 : 32 + 22 - 5,
        opacity: expanded ? 1 : 0,
      },
      dot: {
        top: expanded ? 69 - 41 : 69 - 41 + 22 - 5,
  ...
  render() {
    const {expanded, sourceText, destinationText, hide} = this.props
    ...
    return (
      ...
      <View style={[styles.container, hide ? containerStyle : null]}>
        <Animatable.View
